...
- (void)setUpUI{
    ...
    self.topLabel.textColor = UIColorFromRGB(0xdbdbdb);
    ...
    self.bottomLabel.textColor =  UIColorFromRGB(0x484848);
...
- (void)setType:(NSInteger)type{
    switch (type) {
        ...
        {
            [self setImage:@"meiyou" topLabelText:@"暂时没找到哎" bottomLabelText:@""];
        }
            break;
