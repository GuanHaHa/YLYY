...
#define kPlayBtnSideLength 50.0f
...
//        [_player seekToTime:currentCMTime];
        _player = [AVPlayer playerWithPlayerItem:playerItem];
      
          [_player seekToTime:CMTimeMake(self.value, 1)];
...
- (UIButton *)playOrPauseBtn {
    if (!_playOrPauseBtn) {
        ...
        [_playOrPauseBtn setBackgroundImage:[UIImage imageNamed:@"broadcast"] forState:UIControlStateNormal];
        [_playOrPauseBtn setBackgroundImage:[UIImage imageNamed:@"broadcast_no"] forState:UIControlStateSelected];
