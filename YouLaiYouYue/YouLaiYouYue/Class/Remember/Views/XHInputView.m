...
- (void)keyboardWillAppear:(NSNotification *)noti{
    ...
    if(_textView.isFirstResponder){
        ...
        [UIView animateWithDuration:keyboardAnimationDuration animations:^{
            ...
            if (StatusHeight == 44) {
                frame.origin.y = XHInputView_ScreenH - keyboardSize.height - frame.size.height-88;
            }else {
                frame.origin.y = XHInputView_ScreenH - keyboardSize.height - frame.size.height-64;
            }
