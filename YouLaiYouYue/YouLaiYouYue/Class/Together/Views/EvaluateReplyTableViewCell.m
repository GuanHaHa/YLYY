...
@implementation EvaluateReplyTableViewCell
...
- (void)layoutSubviews {
    ...
    [_bgView autoPinEdgeToSuperviewEdge:ALEdgeLeft withInset:20];
...
- (void)setDic:(NSDictionary *)dic {
    _dic = dic;
    _contnetLabel.text = [NSString stringWithFormat:@"%@:%@",_dic[@"username"],_dic[@"content"]];
}
