...
@implementation EditActivityTableViewCell
...
- (void)setModel:(EditActModel *)model {
    _model = model;
    ...
    _lookLabel.text = [NSString stringWithFormat:@"浏览:%@",_model.look_num];
    _attentionLabel.text = [NSString stringWithFormat:@"关注:%@",_model.pffavorite];
