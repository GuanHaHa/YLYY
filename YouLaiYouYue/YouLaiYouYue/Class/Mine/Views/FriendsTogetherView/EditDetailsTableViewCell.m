...
@interface EditDetailsTableViewCell ()<UICollectionViewDataSource,UICollectionViewDelegateFlowLayout ,EditImgCollectionViewCellDelegate>
...
@implementation EditDetailsTableViewCell
...
//        _collectionView.scrollEnabled = NO;
        [_collectionView registerClass:[EditImgCollectionViewCell class] forCellWithReuseIdentifier:@"EditImgCollectionViewCell"];
    }
...
- ( UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    EditImgCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"EditImgCollectionViewCell" forIndexPath:indexPath];
