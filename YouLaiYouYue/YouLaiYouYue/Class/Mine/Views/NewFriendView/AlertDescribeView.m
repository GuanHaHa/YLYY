...
@interface AlertDescribeView ()<UITextViewDelegate>
...
@implementation AlertDescribeView
...
//    self.repulse_content_textView.text = @"请输入图片描述";
    ...
    self.repulse_content_textView.layer.borderWidth = 0.5;
    
    UILabel *placeHolderLabel = [[UILabel alloc] init];
    placeHolderLabel.text = @"请输入图片描述";
    placeHolderLabel.numberOfLines = 0;
    placeHolderLabel.textColor = [UIColor lightGrayColor];
    [placeHolderLabel sizeToFit];
    [self.repulse_content_textView addSubview:placeHolderLabel];
    // same font
    placeHolderLabel.font = [UIFont systemFontOfSize:13.f];
    [self.repulse_content_textView setValue:placeHolderLabel forKey:@"_placeholderLabel"];
