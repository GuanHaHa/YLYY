...
@implementation InsertContentTableViewCell
...
- (void)textViewDidEndEditing:(UITextView *)textView {
    if ([self.delegate respondsToSelector:@selector(changeInsertTextView:)]) {
        [self.delegate changeInsertTextView:textView.text];
    }
    NSLog(@"%@",textView.text);
}
