...
@implementation EditRemCollectionViewCell
...
- (void)setDic:(NSDictionary *)dic {
    ...
    [_imgView sd_setImageWithURL:[NSURL URLWithString:_dic[@"ffpurl"]] placeholderImage:nil];
    if ([_dic[@"ffptitle"] isEqualToString:@""]) {
        _editLabel.text = @"编辑描述";
    }else {
        _editLabel.text = _dic[@"ffptitle"];
    }
