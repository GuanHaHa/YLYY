...
@implementation ThreeTypeBtnTableViewCell
...
- (UIButton *)btn2 {
    if (!_btn2) {
        ...
        [_btn2 setTitle:@"去评价" forState:UIControlStateNormal];
        [_btn2 setTitle:@"去评价" forState:UIControlStateSelected];
