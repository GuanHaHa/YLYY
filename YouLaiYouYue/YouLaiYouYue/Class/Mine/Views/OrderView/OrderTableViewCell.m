...
- (void)setModel:(OrderModel *)model {
    ...
    [self.img sd_setImageWithURL:[NSURL URLWithString:_model.pf_pic] placeholderImage:nil];
    self.titLabel.text = _model.info;
    self.peopleNum.text = [NSString stringWithFormat:@"参加人数:%@",_model.join_num];
    self.timeLabel.text = [NSString stringWithFormat:@"活动时间:%@",_model.time_info];
    self.costType.text = _model.price_type;
    self.allCost.text = [NSString stringWithFormat:@"合计费用:%@",_model.opaymoney];
}
