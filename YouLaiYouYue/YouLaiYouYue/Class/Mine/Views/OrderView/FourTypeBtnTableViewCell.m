...
@implementation FourTypeBtnTableViewCell
...
- (UIButton *)btn2 {
    if (!_btn2) {
        ...
        [_btn2 setTitle:@"退款中" forState:UIControlStateNormal];
        [_btn2 setTitle:@"退款中" forState:UIControlStateSelected];
