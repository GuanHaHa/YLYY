...
@implementation FiveTypeBtnTableViewCell
...
- (UIButton *)btn2 {
    if (!_btn2) {
        ...
        [_btn2 setTitle:@"已退款" forState:UIControlStateNormal];
        [_btn2 setTitle:@"已退款" forState:UIControlStateSelected];
