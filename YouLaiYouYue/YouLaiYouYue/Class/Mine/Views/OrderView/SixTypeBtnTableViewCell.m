...
@implementation SixTypeBtnTableViewCell
...
- (UIButton *)btn2 {
    if (!_btn2) {
        ...
        [_btn2 setTitle:@"活动中" forState:UIControlStateNormal];
        [_btn2 setTitle:@"活动中" forState:UIControlStateSelected];
