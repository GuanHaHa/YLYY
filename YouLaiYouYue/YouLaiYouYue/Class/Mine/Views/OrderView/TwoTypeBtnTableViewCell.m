...
@implementation TwoTypeBtnTableViewCell
...
- (UIButton *)btn1 {
    if (!_btn1) {
        ...
        [_btn1 setTitle:@"取消活动" forState:UIControlStateNormal];
        [_btn1 setTitle:@"取消活动" forState:UIControlStateSelected];
...
- (UIButton *)btn2 {
    if (!_btn2) {
        ...
        [_btn2 setTitle:@"退款" forState:UIControlStateNormal];
        [_btn2 setTitle:@"退款" forState:UIControlStateSelected];
