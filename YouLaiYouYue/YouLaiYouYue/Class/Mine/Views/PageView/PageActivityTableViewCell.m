...
@implementation PageActivityTableViewCell
...
- (void)layoutSubviews {
    ...
    [_lookBtn autoSetDimension:ALDimensionWidth toSize:SCREEN_WIDTH/3];
    ...
    [_commentBtn autoSetDimension:ALDimensionWidth toSize:SCREEN_WIDTH/3];
    ...
    [_collectBtn autoSetDimension:ALDimensionWidth toSize:SCREEN_WIDTH/3];
...
- (void)setModel:(PageActivityModel *)model {
    _model = model;
    
    [_img sd_setImageWithURL:[NSURL URLWithString:_model.pfpic] placeholderImage:nil];
    _titleLabel.text = _model.pftitle;
    [_lookBtn setTitle:[NSString stringWithFormat:@"浏览:%@",_model.pflook] forState:UIControlStateNormal];
    [_commentBtn setTitle:[NSString stringWithFormat:@"评论:%@",_model.pfcomment] forState:UIControlStateNormal];
    [_collectBtn setTitle:[NSString stringWithFormat:@"收藏:%@",_model.pffavorite] forState:UIControlStateNormal];
