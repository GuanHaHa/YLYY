...
@implementation StartActTableViewCell
...
- (void)setModel:(StartModel *)model {
    ...
    _startTime.text = [NSString stringWithFormat:@"开始时间:%@",_model.pfgotime];
    _endTime.text = [NSString stringWithFormat:@"结束时间:%@",_model.pfendtime];
    _lookLabel.text = [NSString stringWithFormat:@"浏览:%@",_model.pflook];
    _attentionLabel.text = [NSString stringWithFormat:@"关注:%@",_model.focusOn];
    _costLabel.text = [NSString stringWithFormat:@"人均费用:%@",_model.pfspend];
    _numLabel.text = [NSString stringWithFormat:@"报名人数:%@",_model.join_num];
}
