...
- (void)setNavigationBar {
    [self setNavigationBarTitle:@"全部" textColor:UIColorFromRGB(0xffffff) titleFontSize:nil];
}
...
- (void)goPay:(NSString *)orderId with:(NSString *)type{
