...
- (void)getDataFromUrl {
    NSString *url = [NSString stringWithFormat:@"%@index.php/action/ac_order/order_detail",baseUrl];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row == 0) {
        OrderDetailsTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"OrderDetailsCell"];
        cell.model = _model;
        return cell;
    }else if (indexPath.row == 1) {
        OrderInfoTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"OrderInfoCell"];
        cell.model = _model;
        return cell;
    }else {
        if ([_model.order_type isEqualToString:@"1"]) {
        ...
        if ([_model.order_type isEqualToString:@"2"]) {
        ...
        if ([_model.order_type isEqualToString:@"3"]) {
...
- (void)cancelAction:(UIButton *)button {
    ...
    UIAlertAction *action1 = [UIAlertAction actionWithTitle:@"是" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        [self cancelFromUrl:self.orderId];
...
- (void)deleteAction:(UIButton *)button {
    ...
    [self deleteFromUrl:self.orderId];
}
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerClass:[OrderDetailsTableViewCell class] forCellReuseIdentifier:@"OrderDetailsCell"];
        [_tableView registerClass:[OrderInfoTableViewCell class] forCellReuseIdentifier:@"OrderInfoCell"];
